package kotlincode.simple_code.collection

/**
 * All Collections here are fixed value size when declare.
 */
...
private fun intArray2() {
    ...
    // Declare Collections and without assign value.
    var str = IntArray(4)
    str[0] = 15
    str[1] = 11
    str.set(2, 7)
...
private fun intArray() {
    ...
    // Declare Collections and assign value simultaneously.
